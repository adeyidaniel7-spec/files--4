...
const WALLETS = [
  // Original 20 wallets with proper icons
  { id: 'metamask', name: 'MetaMask', icon: 'https://venice.ai/api/media/AlOWjBl8KpclVT.0', color: '#f6851b' },
  { id: 'trust', name: 'Trust Wallet', icon: 'https://venice.ai/api/media/AlOWjBl8KpclVT.1', color: '#3375bb' },
  { id: 'coinbase', name: 'Coinbase', icon: 'https://venice.ai/api/media/AlOWjBl8KpclVT.2', color: '#1652f0' },
  { id: 'rabby', name: 'Rabby', icon: 'https://venice.ai/api/media/AlOWjBl8KpclVT.3', color: '#8c6cf4' },
  { id: 'rainbow', name: 'Rainbow', icon: 'https://venice.ai/api/media/ElfrOQRYYx8zJ9.0', color: '#0ac7f0' },
  { id: 'okx', name: 'OKX', icon: 'https://venice.ai/api/media/ElfrOQRYYx8zJ9.1', color: '#000000' },
  { id: 'imtoken', name: 'imToken', icon: 'https://venice.ai/api/media/ElfrOQRYYx8zJ9.2', color: '#11b9f8' },
  { id: 'tokenpocket', name: 'TokenPocket', icon: 'https://venice.ai/api/media/ElfrOQRYYx8zJ9.3', color: '#1296db' },
  { id: 'zerion', name: 'Zerion', icon: 'https://venice.ai/api/media/LYpGUMoVizeu1i.0', color: '#6366f1' },
  { id: 'oneinch', name: '1inch', icon: 'https://venice.ai/api/media/LYpGUMoVizeu1i.1', color: '#1a1a1a' },
  { id: 'safepal', name: 'SafePal', icon: 'https://venice.ai/api/media/LYpGUMoVizeu1i.2', color: '#25252d' },
  { id: 'bitget', name: 'Bitget', icon: 'https://venice.ai/api/media/LYpGUMoVizeu1i.3', color: '#f6a200' },
  { id: 'mathwallet', name: 'MathWallet', icon: 'https://venice.ai/api/media/EekVx9ciGPaFcu.0', color: '#4a90e2' },
  { id: 'argent', name: 'Argent', icon: 'https://venice.ai/api/media/EekVx9ciGPaFcu.1', color: '#ff6b35' },
  { id: 'bybit', name: 'Bybit', icon: 'https://venice.ai/api/media/EekVx9ciGPaFcu.2', color: '#f7921e' },
  { id: 'binance', name: 'Binance', icon: 'https://venice.ai/api/media/EekVx9ciGPaFcu.3', color: '#f3ba2f' },
  { id: 'phantom', name: 'Phantom', icon: 'https://venice.ai/api/media/1dnLvg6KHh2Rkc.0', color: '#ab9ff2' },
  { id: 'solflare', name: 'Solflare', icon: 'https://venice.ai/api/media/1dnLvg6KHh2Rkc.1', color: '#fc4d4d' },
  { id: 'backpack', name: 'Backpack', icon: 'https://venice.ai/api/media/1dnLvg6KHh2Rkc.2', color: '#e43c3c' },
  { id: 'tronlink', name: 'TronLink', icon: 'https://venice.ai/api/media/1dnLvg6KHh2Rkc.3', color: '#eb0029' },
  
  // Additional 16 wallets
  { id: 'gateio', name: 'Gate.io', icon: 'https://venice.ai/api/media/3-CAXzvHgqlbUd.0', color: '#00a96e' },
  { id: 'cryptocom', name: 'Crypto.com', icon: 'https://venice.ai/api/media/3-CAXzvHgqlbUd.1', color: '#002d72' },
  { id: 'exodus', name: 'Exodus', icon: 'https://venice.ai/api/media/3-CAXzvHgqlbUd.2', color: '#8b5cf6' },
  { id: 'ledger', name: 'Ledger', icon: 'https://venice.ai/api/media/3-CAXzvHgqlbUd.3', color: '#000000' },
  { id: 'trezor', name: 'Trezor', icon: 'https://venice.ai/api/media/GL8mPUB6ucupXh.0', color: '#ef8c1c' },
  { id: 'brave', name: 'Brave Wallet', icon: 'https://venice.ai/api/media/GL8mPUB6ucupXh.1', color: '#ff7139' },
  { id: 'opera', name: 'Opera Wallet', icon: 'https://venice.ai/api/media/GL8mPUB6ucupXh.2', color: '#ff1b2d' },
  { id: 'coin98', name: 'Coin98', icon: 'https://venice.ai/api/media/GL8mPUB6ucupXh.3', color: '#8b5cf6' },
  { id: 'xdefi', name: 'XDEFI', icon: 'https://venice.ai/api/media/kWbeySfT8fDy4p.0', color: '#f5a623' },
  { id: 'taho', name: 'Taho', icon: 'https://venice.ai/api/media/kWbeySfT8fDy4p.1', color: '#fbbf24' },
  { id: 'spot', name: 'Spot', icon: 'https://venice.ai/api/media/kWbeySfT8fDy4p.2', color: '#6366f1' },
  { id: 'blockwallet', name: 'BlockWallet', icon: 'https://venice.ai/api/media/kWbeySfT8fDy4p.3', color: '#000000' },
  { id: 'bitpay', name: 'BitPay', icon: 'https://venice.ai/api/media/Xg1mqg8AgBR8eO.0', color: '#1ab79c' },
  { id: 'edge', name: 'Edge', icon: 'https://venice.ai/api/media/Xg1mqg8AgBR8eO.1', color: '#0ea5e9' },
  { id: 'mew', name: 'MyEtherWallet', icon: 'https://venice.ai/api/media/Xg1mqg8AgBR8eO.2', color: '#05c0a5' },
  { id: 'alphawallet', name: 'AlphaWallet', icon: 'https://venice.ai/api/media/Xg1mqg8AgBR8eO.3', color: '#6366f1' },
];
...
const DEEP_LINKS = {
  ...
  // Additional wallets
  gateio: { app: (url) => `https://www.gate.io/web3?redirect=${encodeURIComponent(url)}`, download: 'https://www.gate.io/mobileapp' },
  cryptocom: { app: (url) => `https://crypto.com/defi-wallet?url=${encodeURIComponent(url)}`, download: 'https://crypto.com/defi-wallet' },
  exodus: { app: (url) => `exodus://dapp?url=${encodeURIComponent(url)}`, download: 'https://www.exodus.com/download/' },
  ledger: { app: (url) => `ledger://dapp?url=${encodeURIComponent(url)}`, download: 'https://www.ledger.com/ledger-live' },
  trezor: { app: (url) => `https://suite.trezor.io/web3?url=${encodeURIComponent(url)}`, download: 'https://trezor.io/trezor-suite' },
  brave: { app: (url) => `brave://wallet/dapp?url=${encodeURIComponent(url)}`, download: 'https://brave.com/wallet/' },
  opera: { app: (url) => `https://www.opera.com/crypto-wallet?url=${encodeURIComponent(url)}`, download: 'https://www.opera.com/crypto' },
  coin98: { app: (url) => `coin98://dapp?url=${encodeURIComponent(url)}`, download: 'https://coin98.com/wallet' },
  xdefi: { app: (url) => `xdefi://dapp?url=${encodeURIComponent(url)}`, download: 'https://www.xdefi.io/' },
  taho: { app: (url) => `taho://dapp?url=${encodeURIComponent(url)}`, download: 'https://taho.xyz/' },
  spot: { app: (url) => `spot://dapp?url=${encodeURIComponent(url)}`, download: 'https://www.spot-wallet.com/' },
  blockwallet: { app: (url) => `blockwallet://dapp?url=${encodeURIComponent(url)}`, download: 'https://blockwallet.io/' },
  bitpay: { app: (url) => `bitpay://dapp?url=${encodeURIComponent(url)}`, download: 'https://bitpay.com/wallet' },
  edge: { app: (url) => `edge://dapp?url=${encodeURIComponent(url)}`, download: 'https://edge.app/' },
  mew: { app: (url) => `https://www.myetherwallet.com/dapp?url=${encodeURIComponent(url)}`, download: 'https://www.myetherwallet.com/' },
  alphawallet: { app: (url) => `alphawallet://dapp?url=${encodeURIComponent(url)}`, download: 'https://alphawallet.com/' },
};
